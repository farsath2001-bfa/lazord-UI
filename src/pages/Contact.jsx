...
const Contact = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post(`${import.meta.env.VITE_API_URL}/api/leads`, {
        ...
        service: form.service || 'General Inquiry', message: form.message, source: 'Contact Form'
      })
  ...
  const inputStyle = {
    width: '100%', backgroundColor: '#060f26', border: '1px solid rgba(45,95,196,0.3)',
    borderRadius: '10px', color: '#ffffff', padding: '13px 16px', fontSize: '0.92rem',
    ...
    <div style={{ backgroundColor: '#060f26', minHeight: '100vh', paddingBottom: '80px' }}>
      ...
      <div style={{ backgroundColor: '#0d1f4e', borderBottom: '1px solid rgba(45,95,196,0.3)', padding: '50px 0 40px', position: 'relative', overflow: 'hidden' }}>
        ...
        <Container>
          ...
          <p style={{ color: '#8aafd4', fontSize: '0.95rem', lineHeight: '1.8', maxWidth: '540px' }}>{t('contact.subtitle')}</p>
        </Container>
      </div>
      ...
      <Container style={{ paddingTop: '48px' }}>
        ...
        {/* Info Cards */}
        <div ref={infoRef}>
          <Row className="g-3" style={{ marginBottom: '36px' }}>
            {contactInfo.map((info, i) => (
              <Col key={i} lg={3} sm={6} xs={12}>
                <div style={{ backgroundColor: '#0d1f4e', border: '1px solid rgba(45,95,196,0.25)', borderRadius: '14px', padding: '20px 16px', height: '100%', transition: 'all 0.25s ease' }}
        ...
        {/* Social Media */}
        <div ref={socialRef} style={{ backgroundColor: '#0d1f4e', border: '1px solid rgba(45,95,196,0.25)', borderRadius: '16px', padding: '24px', marginBottom: '36px' }}>
          ...
          <div style={{ display: 'flex', gap: '10px', flexWrap: 'wrap' }}>
            {socialMedia.map((social, i) => (
              <a key={i} href={social.url} target="_blank" rel="noopener noreferrer"
                style={{ display: 'flex', alignItems: 'center', gap: '8px', backgroundColor: 'rgba(255,255,255,0.05)', border: '1px solid rgba(45,95,196,0.25)', borderRadius: '10px', padding: '8px 14px', textDecoration: 'none', transition: 'all 0.25s ease', color: '#ffffff' }}
                onMouseEnter={e => { e.currentTarget.style.backgroundColor = `${social.color}25`; e.currentTarget.style.borderColor = social.color; e.currentTarget.style.transform = 'translateY(-3px)'; e.currentTarget.querySelector('.si').style.color = social.color }}
                onMouseLeave={e => { e.currentTarget.style.backgroundColor = 'rgba(255,255,255,0.05)'; e.currentTarget.style.borderColor = 'rgba(45,95,196,0.25)'; e.currentTarget.style.transform = 'translateY(0)'; e.currentTarget.querySelector('.si').style.color = '#8aafd4' }}>
                <span className="si" style={{ color: '#8aafd4', transition: 'color 0.25s', display: 'flex' }}>{social.svg}</span>
        ...
        <Row className="g-4">
          {/* Form */}
          <Col lg={7} xs={12} ref={formRef}>
            <div style={{ backgroundColor: '#0d1f4e', border: '1px solid rgba(45,95,196,0.3)', borderRadius: '20px', padding: 'clamp(20px, 4vw, 40px)' }}>
              ...
              {submitted ? (
                <div style={{ backgroundColor: 'rgba(39,174,96,0.12)', border: '1px solid rgba(39,174,96,0.3)', borderRadius: '14px', padding: '40px 24px', textAlign: 'center' }}>
                ...
                <form onSubmit={handleSubmit}>
                  <Row className="g-3">
                    ...
                    <Col xs={12}>
                      ...
                      <textarea name="message" rows={4} placeholder="Tell us about your property requirements..." value={form.message} onChange={handleChange} style={{ ...inputStyle, resize: 'vertical' }} onFocus={e => e.target.style.borderColor = '#4a90d9'} onBlur={e => e.target.style.borderColor = 'rgba(45,95,196,0.3)'} />
                    </Col>
                    <Col xs={12}>
          ...
          {/* Right side */}
          <Col lg={5} xs={12} ref={sideRef}>
            <div style={{ backgroundColor: '#0d1f4e', border: '1px solid rgba(37,211,102,0.3)', borderRadius: '16px', padding: '24px', marginBottom: '16px' }}>
              ...
              <a href="https://wa.me/971561119233?text=Hello, I'm interested in a property from Lazord Real Estate."
                target="_blank" rel="noopener noreferrer"
                style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px', backgroundColor: '#25d366', color: '#fff', padding: '13px', borderRadius: '10px', textDecoration: 'none', fontWeight: '700', fontSize: '0.9rem', transition: 'background 0.2s ease' }}
            ...
            <div style={{ backgroundColor: '#0d1f4e', border: '1px solid rgba(45,95,196,0.25)', borderRadius: '16px', overflow: 'hidden' }}>
              <iframe title="Lazord Office Location"
                ...
                width="100%" height="240" style={{ border: 0, display: 'block', filter: 'invert(90%) hue-rotate(180deg)' }} allowFullScreen="" loading="lazy" />
