...
const socialMedia = [
  {
    name: 'Facebook',
    color: '#1877F2',
    url: 'https://www.facebook.com/share/1E8S4YPqL7/',
  ...
  },
  {
    name: 'Instagram',
    color: '#E4405F',
    url: 'https://www.instagram.com/lazord_real.estate?igsh=MXd0NHp5c2hjYW1kbg==',
  ...
  },
  {
    ...
    svg: <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.746l7.73-8.835L1.254 2.25H8.08l4.258 5.63 5.906-5.63zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
  },
  {
    name: 'YouTube',
    color: '#FF0000',
    url: 'https://youtube.com',
    svg: <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M23.495 6.205a3.007 3.007 0 00-2.088-2.088c-1.87-.501-9.396-.501-9.396-.501s-7.507-.01-9.396.501A3.007 3.007 0 00.527 6.205a31.247 31.247 0 00-.522 5.805 31.247 31.247 0 00.522 5.783 3.007 3.007 0 002.088 2.088c1.868.502 9.396.502 9.396.502s7.506 0 9.396-.502a3.007 3.007 0 002.088-2.088 31.247 31.247 0 00.5-5.783 31.247 31.247 0 00-.5-5.805zM9.609 15.601V8.408l6.264 3.602z"/></svg>
  },
  {
    name: 'TikTok',
    color: '#010101',
  ...
  return (
    <div style={{ backgroundColor: '#060f26', minHeight: '100vh', paddingBottom: '80px' }}>
      ...
      <Container style={{ paddingTop: '60px' }}>
        ...
        <Row className="g-4" style={{ marginBottom: '48px' }}>
          {contactInfo.map((info, i) => (
            <Col key={i} lg={3} md={6}>
              ...
              >
                <div style={{ width: '48px', height: '48px', borderRadius: '12px', backgroundColor: `${info.color}20`, border: `1px solid ${info.color}40`, display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '1.4rem', marginBottom: '14px' }}>
                  {info.icon}
                </div>
        ...
        <div style={{ backgroundColor: '#0d1f4e', border: '1px solid rgba(45,95,196,0.25)', borderRadius: '16px', padding: '32px', marginBottom: '40px' }}>
          <div style={{ marginBottom: '24px' }}>
            <h2 style={{ color: '#ffffff', fontSize: '1.2rem', fontWeight: '700', marginBottom: '6px' }}>
            ...
            {socialMedia.map((social, i) => (
              <a
                ...
                onMouseEnter={e => {
                  ...
                  e.currentTarget.querySelector('.social-icon').style.color = social.color
                }}
                onMouseLeave={e => {
                  ...
                  e.currentTarget.querySelector('.social-icon').style.color = '#8aafd4'
                }}
              >
                <span className="social-icon" style={{ color: '#8aafd4', transition: 'color 0.25s ease', display: 'flex' }}>
                  {social.svg}
                </span>
              ...
              {submitted ? (
                ...
                <form onSubmit={handleSubmit}>
                  <Row className="g-3">
                    ...
                    <Col md={12}>
                      <button type="submit" disabled={loading} style={{ width: '100%', backgroundColor: loading ? '#1a3a7c' : '#2d5fc4', color: '#fff', border: 'none', borderRadius: '10px', padding: '15px', fontSize: '0.95rem', fontWeight: '700', cursor: loading ? 'not-allowed' : 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px' }}
