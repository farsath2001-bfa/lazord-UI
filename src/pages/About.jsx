...
const team = [
  {
    name: 'Mohammed Al Nimer',
    role: 'CEO ',
    exp: '15 Years Experience',
    avatar: 'M',
    color: '#2d5fc4',
    langs: 'Arabic, English',
    spec: 'Luxury Villas & Penthouses'
  },
  {
    name: 'Khairy',
      ...
      <Container style={{ paddingTop: '70px' }}>
        ...
        <Row className="align-items-center g-5" style={{ marginBottom: '80px' }}>
          <Col lg={6}>
            ...
            <h2 style={{ color: '#4a90d9', fontSize: 'clamp(1.6rem, 3vw, 2.4rem)', fontWeight: '800', marginBottom: '20px' }}>
              Shaping Dubai Living
            </h2>
              ...
              {milestones.map((m, i) => (
                <div key={i} style={{ display: 'flex', gap: '16px', alignItems: 'flex-start' }}>
                  <div style={{
                    ...
                    color: '#4a90d9', fontWeight: '800', fontSize: '0.82rem'
                  }}>
                    {m.year}
                  </div>
                  <div style={{
                    backgroundColor: '#0d1f4e',
                    border: '1px solid rgba(45,95,196,0.2)',
            ...
            {values.map((v, i) => (
              <Col key={i} lg={3} md={6}>
                <div style={{
                  ...
                  borderRadius: '14px', padding: '28px 22px', textAlign: 'center', height: '100%',
                  transition: 'all 0.25s ease'
                }}
                  onMouseEnter={e => {
                    e.currentTarget.style.borderColor = '#4a90d9'
              ...
              <Col key={i} lg={4} md={6}>
                <div style={{
                  ...
                  onMouseEnter={e => {
                    e.currentTarget.style.borderColor = '#4a90d9'
                    e.currentTarget.style.transform = 'translateY(-4px)'
                    e.currentTarget.style.boxShadow = '0 16px 40px rgba(45,95,196,0.2)'
                  }}
                  onMouseLeave={e => {
                    e.currentTarget.style.borderColor = 'rgba(45,95,196,0.25)'
                    e.currentTarget.style.transform = 'translateY(0)'
                ...
                >
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                    {[
                      { icon: '🏆', text: member.exp },
                      { icon: '🌍', text: member.langs },
                      { icon: '🏠', text: member.spec },
                    ].map((item, j) => (
        ...
        <div style={{
          ...
          border: '1px solid rgba(74,144,217,0.3)',
          borderRadius: '20px', padding: '56px 48px', textAlign: 'center'
        }}>
          <h2 style={{ color: '#ffffff', fontSize: 'clamp(1.5rem, 3vw, 2.2rem)', fontWeight: '300', marginBottom: '6px' }}>
            Ready to Start Your
          </h2>
          <h2 style={{ color: '#4a90d9', fontSize: 'clamp(1.5rem, 3vw, 2.2rem)', fontWeight: '800', marginBottom: '16px' }}>
            Dubai Property Journey?
          </h2>
          <p style={{ color: '#8aafd4', fontSize: '1rem', marginBottom: '32px', maxWidth: '460px', margin: '0 auto 32px' }}>
            Our team is ready to help you find, buy, rent or sell your property in Dubai.
          </p>
          <div style={{ display: 'flex', gap: '14px', justifyContent: 'center', flexWrap: 'wrap' }}>
            <Link to="/properties" style={{
              backgroundColor: '#2d5fc4', color: '#fff', padding: '13px 28px',
            ...
            <Link to="/contact" style={{
              backgroundColor: 'transparent', color: '#ffffff', padding: '13px 28px',
              borderRadius: '10px', textDecoration: 'none', fontWeight: '600',
              fontSize: '0.92rem', border: '1.5px solid rgba(255,255,255,0.25)',
