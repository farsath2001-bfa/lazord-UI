...
const IMAGE_SERVICES = 'https://images.unsplash.com/photo-1545324418-cc1a3fa10c00?w=800&q=80'
      ...
      <Container style={{ paddingTop: '70px' }}>
        ...
        <Row className="align-items-center g-5" style={{ marginBottom: '80px' }}>
          <Col lg={6} ref={storyLeftRef}>
            ...
            <p style={{ color: '#8aafd4', fontSize: '0.95rem', lineHeight: '1.9', marginBottom: '16px' }}>
              As a fully licensed RERA and DED brokerage, we are trusted intermediaries for major UAE master developers including Nakheel and Dubai Properties — connecting visionary investors with prime real estate opportunities.
            </p>
        ...
        {/* Milestones */}
        <div ref={milestonesRef} style={{ marginBottom: '80px' }}>
        ...
        <div ref={missionRef} style={{ marginBottom: '80px' }}>
          ...
          <Row className="g-4">
            {[
              { icon: '🎯', title: 'Mission', color: '#4a90d9', desc: 'To provide accurate, transparent, and actionable real estate advice to every client — constantly creating innovative solutions and working in partnership with clients as a trusted advisor and reliable source of wealth-generating strategy.' },
              { icon: '💎', title: 'Core Values', color: '#ffffff', grad: true, desc: 'Professionalism, Transparency, Market Knowledge, and Client-Centricity — striving to set the highest standards of customer service and intensify our focus on absolute client satisfaction.' },
              { icon: '🔭', title: 'Vision', color: '#4a90d9', desc: 'To be the most trusted brokerage in Dubai, known for integrity and long-term relationships — connecting visionary investors with prime real estate and inviting opportunities offering exceptional returns.' },
            ].map((item, i) => (
              <Col key={i} lg={4} md={12}>
                <div style={{ ...cardStyle, borderColor: 'rgba(45,95,196,0.4)', ...(item.grad ? { background: 'linear-gradient(135deg, #0d1f4e 0%, #1a3a7c 100%)' } : {}) }}
                  ...
                  <h4 style={{ color: item.color, fontWeight: '800', fontSize: '1.1rem', marginBottom: '14px', textTransform: 'uppercase', letterSpacing: '1px' }}>{item.title}</h4>
        ...
        <div ref={servicesRef} style={{ marginBottom: '80px' }}>
          <div style={{ textAlign: 'center', marginBottom: '48px' }}>
            ...
            <h2 style={{ color: '#4a90d9', fontSize: 'clamp(1.6rem, 3vw, 2.4rem)', fontWeight: '800' }}>Offer</h2>
          </div>
          <Services />
        </div>
        ...
        {/* CTA */}
        <div ref={ctaRef} style={{ background: 'linear-gradient(135deg, #0d1f4e 0%, #1a3a7c 50%, #0d1f4e 100%)', border: '1px solid rgba(74,144,217,0.3)', borderRadius: '20px', padding: 'clamp(28px, 5vw, 56px) clamp(20px, 4vw, 48px)', textAlign: 'center' }}>
          ...
          <p style={{ color: '#8aafd4', fontSize: '1rem', maxWidth: '500px', margin: '0 auto 12px' }}>Our team is ready to help you find, buy, rent or sell your property in Dubai.</p>
