...
const PropertyDetail = () => {
    ...
    return (
      <div style={{ backgroundColor: '#060f26', minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        <div style={{ textAlign: 'center' }}>
          ...
          <p style={{ color: '#8aafd4', marginBottom: '24px' }}>This property may have been removed or the link is incorrect.</p>
          <Link to="/properties" style={{
            backgroundColor: '#2d5fc4', color: '#fff', padding: '12px 28px',
  ...
  const similar = propertiesData.filter(p => p.id !== property.id && p.type === property.type).slice(0, 3)
      ...
      <Container style={{ paddingTop: '36px' }}>
        <Row className="g-4">
          ...
          <Col lg={8}>
            ...
            <div style={{ borderRadius: '16px', overflow: 'hidden', marginBottom: '12px', position: 'relative' }}>
              ...
              {property.roi && (
                <div style={{
                  ...
                  backgroundColor: 'rgba(39,174,96,0.9)', color: '#fff',
                  fontSize: '0.75rem', fontWeight: '700', padding: '5px 14px', borderRadius: '20px'
                }}>
                  ROI {property.roi}
                </div>
              )}
                ...
                {property.gallery.map((img, i) => (
                  <div
                    ...
                    style={{
                      ...
                      cursor: 'pointer', border: i === activeImg ? '2px solid #4a90d9' : '2px solid transparent',
                      opacity: i === activeImg ? 1 : 0.6, transition: 'all 0.2s ease'
                    }}
                  >
            ...
            <div style={{ marginBottom: '24px' }}>
              <div style={{ color: '#4a90d9', fontSize: '0.85rem', marginBottom: '8px' }}>
                📍 {property.location} — {property.community}
              </div>
              <h1 style={{ color: '#ffffff', fontSize: 'clamp(1.5rem, 3vw, 2.2rem)', fontWeight: '700', marginBottom: '12px' }}>
                {property.title}
              </h1>
              <div style={{ display: 'flex', gap: '8px', flexWrap: 'wrap' }}>
                <span style={{
                  backgroundColor: 'rgba(45,95,196,0.2)', color: '#4a90d9',
                  padding: '4px 12px', borderRadius: '20px', fontSize: '0.8rem', fontWeight: '600'
                }}>{property.category}</span>
                <span style={{
                  backgroundColor: property.status === 'Off Plan' ? 'rgba(142,68,173,0.2)' : 'rgba(39,174,96,0.2)',
                  color: property.status === 'Off Plan' ? '#8e44ad' : '#27ae60',
                  padding: '4px 12px', borderRadius: '20px', fontSize: '0.8rem', fontWeight: '600'
            ...
            <div style={{ ...infoBoxStyle, marginBottom: '24px' }}>
              ...
              <p style={{ color: '#8aafd4', fontSize: '0.92rem', lineHeight: '1.8', margin: 0 }}>
            ...
            {/* Amenities */}
            <div style={{ ...infoBoxStyle, marginBottom: '24px' }}>
              <h3 style={{ color: '#ffffff', fontSize: '1.1rem', fontWeight: '700', marginBottom: '16px' }}>
                Amenities & Features
              </h3>
            ...
            <div style={{ position: 'sticky', top: '100px' }}>
              ...
              <div style={{
                ...
                {property.status === 'Off Plan' && (
                  <div style={{
                    backgroundColor: 'rgba(142,68,173,0.15)', border: '1px solid rgba(142,68,173,0.3)',
                    borderRadius: '8px', padding: '10px 14px', marginBottom: '20px',
                    color: '#8e44ad', fontSize: '0.82rem'
                  }}>
                ...
                {/* WhatsApp */}
                <a href={`https://wa.me/97142981077?text=Hi, I'm interested in: ${property.title}`}
                  target="_blank" rel="noopener noreferrer"
                  style={{
                    display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px',
                    backgroundColor: '#25d366', color: '#fff', padding: '13px',
                    borderRadius: '10px', textDecoration: 'none', fontWeight: '700',
                    fontSize: '0.9rem', marginBottom: '10px', transition: 'background 0.2s ease'
                  }}
                ...
                <a href="tel:+97142981077" style={{
                  display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px',
                  backgroundColor: 'transparent', color: '#ffffff', padding: '13px',
                  borderRadius: '10px', textDecoration: 'none', fontWeight: '600',
                  fontSize: '0.9rem', border: '1.5px solid rgba(255,255,255,0.2)', transition: 'all 0.2s ease'
                }}
              ...
              <div style={{
                ...
                <h3 style={{ color: '#ffffff', fontSize: '1rem', fontWeight: '700', marginBottom: '18px' }}>
                  Send an Enquiry
                </h3>

                {submitted ? (
                  <div style={{
                    backgroundColor: 'rgba(39,174,96,0.15)', border: '1px solid rgba(39,174,96,0.3)',
                  ...
                  <form onSubmit={handleSubmit}>
                    ...
                    <textarea
                      ...
                      style={{
                        ...
                        border: '1px solid rgba(45,95,196,0.3)', borderRadius: '8px',
                        color: '#ffffff', padding: '11px 14px', fontSize: '0.88rem',
                        outline: 'none', marginBottom: '12px', resize: 'vertical', boxSizing: 'border-box'
                      }}
                    />
                    <button type="submit" style={{
                      width: '100%', backgroundColor: '#2d5fc4', color: '#fff',
                      border: 'none', borderRadius: '8px', padding: '13px',
                      fontSize: '0.92rem', fontWeight: '700', cursor: 'pointer', transition: 'background 0.2s ease'
                    }}
        ...
        {similar.length > 0 && (
          <div style={{ marginTop: '60px' }}>
            <h2 style={{ color: '#ffffff', fontSize: '1.5rem', fontWeight: '700', marginBottom: '24px' }}>
              Similar Properties
            </h2>
            <Row className="g-4">
              {similar.map(p => (
                <Col key={p.id} lg={4} md={6}>
                  <Link to={`/property/${p.id}`} style={{ textDecoration: 'none' }} onClick={() => window.scrollTo(0, 0)}>
                    <div style={{
                      backgroundColor: '#0d1f4e', border: '1px solid rgba(45,95,196,0.25)',
                      borderRadius: '14px', overflow: 'hidden', transition: 'transform 0.25s ease'
                    }}
