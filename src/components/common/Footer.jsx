    ...
    <footer style={{ backgroundColor: '#0a1630', borderTop: '2px solid #2d5fc4', color: '#ffffff' }}>
      ...
      <div style={{ backgroundColor: '#0d1f4e', borderBottom: '1px solid rgba(45,95,196,0.2)', padding: '32px 0' }}>
        <Container>
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: '20px' }}>
            <div>
              <h3 style={{ color: '#ffffff', fontSize: '1.1rem', fontWeight: '700', margin: 0 }}>📬 Stay Updated on Dubai Property Market</h3>
      ...
      <Container className="py-5">
        <Row className="g-4">
            ...
            <div style={{ display: 'flex', gap: '8px', flexWrap: 'wrap' }}>
              {socialMedia.map((social, i) => (
                <a key={i} href={social.url} target="_blank" rel="noopener noreferrer" title={social.name}
                  style={{ width: '36px', height: '36px', borderRadius: '8px', backgroundColor: 'rgba(255,255,255,0.06)', border: '1px solid rgba(45,95,196,0.25)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#8aafd4', textDecoration: 'none', transition: 'all 0.25s ease' }}
          ...
          {/* Quick Links */}
          <Col lg={4} md={6} xs={6}>
            <h6 style={{ color: '#2d5fc4', marginBottom: '14px', letterSpacing: '1px', textTransform: 'uppercase', fontSize: '0.82rem' }}>{t('footer.quickLinks')}</h6>
            <ul className="list-unstyled">
              {quickLinks.map(item => (
                <li key={item.path} style={{ marginBottom: '8px' }}>
                  <Link to={item.path} style={{ color: '#aab4cc', textDecoration: 'none', fontSize: '0.88rem', transition: 'color 0.2s ease' }}
                    onMouseEnter={e => e.currentTarget.style.color = '#4a90d9'}
                    onMouseLeave={e => e.currentTarget.style.color = '#aab4cc'}>
                    → {item.label}
                  </Link>
                </li>
              ))}
          ...
          {/* Contact */}
          <Col lg={4} md={6} xs={6}>
            <h6 style={{ color: '#2d5fc4', marginBottom: '14px', letterSpacing: '1px', textTransform: 'uppercase', fontSize: '0.82rem' }}>{t('footer.contactUs')}</h6>
            <ul className="list-unstyled" style={{ color: '#aab4cc', fontSize: '0.86rem', marginBottom: '16px' }}>
              <li style={{ marginBottom: '8px' }}>📍 Office 803, AlSalemiya Tower, Rigga Al Butteen, Dubai, UAE</li>
              <li style={{ marginBottom: '8px' }}>📞 +971 42 999 088</li>
              <li style={{ marginBottom: '12px' }}>✉️ info@lazordrealestate.ae</li>
            </ul>
            <div style={{ borderRadius: '12px', overflow: 'hidden', border: '1px solid rgba(45,95,196,0.35)' }}>
              <iframe title="Lazord Real Estate Location"
                ...
                width="100%" height="160" style={{ border: 0, display: 'block' }} allowFullScreen="" loading="lazy" referrerPolicy="no-referrer-when-downgrade" />
            </div>
            <a href="https://maps.google.com/?q=AlSalemiya+Tower+Rigga+Al+Butteen+Deira+Dubai" target="_blank" rel="noopener noreferrer"
        ...
        <p className="text-center mb-0" style={{ color: '#555f7a', fontSize: '0.82rem' }}>
          {t('footer.rights')}
        </p>
      </Container>
    </footer>
