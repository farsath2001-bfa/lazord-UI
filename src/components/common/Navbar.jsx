  ...
  return (
    <>
      <BsNavbar
        ...
        sticky="top"
        style={{
          backgroundColor: scrolled ? 'rgba(13,31,78,0.98)' : '#0d1f4e',
          borderBottom: '1px solid rgba(45,95,196,0.4)',
          minHeight: '70px', padding: '0',
          zIndex: 1000,
        ...
        <Container fluid style={{ padding: '0 20px' }}>
          ...
          >
            <div style={{ border: '2px solid rgba(255,255,255,0.8)', borderRadius: '8px', padding: '2px 5px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              <img src={logo} alt="Lazord" style={{ height: '44px', width: 'auto', objectFit: 'contain', display: 'block' }} />
            </div>
          ...
          <BsNavbar.Collapse id="main-navbar">
            ...
            <div className="d-none d-lg-flex align-items-center" style={{ gap: '12px', flexShrink: 0 }}>
              ...
              {/* Phone number */}
              <a href="tel:+97142999088"
                style={{ display: 'flex', alignItems: 'center', gap: '8px', color: '#ffffff', textDecoration: 'none', fontSize: '0.82rem', letterSpacing: '0.3px', transition: 'color 0.2s ease' }}
            ...
            <div className="d-lg-none" style={{ padding: '16px 0 8px', borderTop: '1px solid rgba(45,95,196,0.2)', marginTop: '8px' }}>
              ...
              <Link to="/contact" onClick={() => setExpanded(false)}
                style={{ display: 'block', color: '#ffffff', border: '1.5px solid rgba(255,255,255,0.3)', borderRadius: '8px', padding: '12px 16px', fontSize: '0.88rem', textDecoration: 'none', textAlign: 'center', backgroundColor: 'rgba(45,95,196,0.15)' }}>
                {t('nav.bookValuation')}
              </Link>
            </div>
          </BsNavbar.Collapse>
